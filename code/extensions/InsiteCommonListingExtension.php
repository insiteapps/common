...
class InsiteCommonListingExtension extends DataExtension
{
    function getPageSetupFields()
    {
        $fields = CompositeField::create(
            ...
            ToggleCompositeField::create('SettingsConfiguration', 'Settings', [
                DropdownField::create("SidebarPosition", "Sidebar position")->setSource(["left" => "left", "right" => "right"])
            ]),
    ...
    private static $db = array(
        "SidebarPosition" => "Enum('left,right','left')",
